...
//await this.sendFile(m.chat, stiker, 'error.jpg', null, m, false, { contextInfo: { mentionedJid: [m.sender], externalAdReply: { showAdAttribution: true, mediaType: 'VIDEO', mediaUrl: null, title: 'رايلي بوت', body: '『👑┇𝚁𝙰𝙸𝙻𝚈┇🤖┇𝙱𝙾𝚃┇👑』', thumbnail: img, sourceUrl: `https://chat.whatsapp.com/BzJhdxwVlte1unMYgieoYQ`}}})  
}}
return !0
}
