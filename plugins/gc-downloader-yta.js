...
if (!args[0]) throw '*[❗ملاحظه❗] يرجى كتابة الامر وجنبه الرابط لتحويل المقطع لمقطع صوتي*'
await m.reply(`*جارري تحميل الموسيقى يرجى الانتظار لحظه*`)
try {
let q = '128kbps'
let v = args[0]
...
handler.command = /^fgmp3|اغنيه|موسيقى(a|yt)$/i
